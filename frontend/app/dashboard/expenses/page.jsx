...
import { ArrowUpRight, TrendingDown, Clock, Trash2, Pencil, Plus } from 'lucide-react'
        ...
        <div className="p-8 font-sans space-y-8">
            <header className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-400 mt-2">Manage your spending</p>
                </div>
                <button
            ...
            {/* Expense Stats */}
            <div className="bg-zinc-900 border border-zinc-800 p-6 rounded-2xl shadow-lg hover:border-red-500/30 transition-all duration-300 group max-w-md">
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-gray-400">{expenseTransactions.length} transactions</span>
                </div>
                ...
                {expenseTransactions.length === 0 ? (
                    <div className="bg-zinc-900/50 border border-zinc-800 border-dashed rounded-2xl p-12 text-center">
                        ...
                        <p className="text-gray-400 mt-1">Track your spending here</p>
                    </div>
                ) : (
